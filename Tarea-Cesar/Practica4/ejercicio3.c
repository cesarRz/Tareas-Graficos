...
void dibuja_circulo(int base_x, int base_y, int color[4]){

    glColor4ub(color[0], color[1], color[2], color[3]);

    glPushMatrix();
        glTranslatef(base_x, base_y, 1);
...
void dibuja(){
    ...
    dibuja_circulo(300, 340, color_rojo);
    dibuja_circulo(300, 240, color_amarillo);
    dibuja_circulo(300, 140, color_verde);
